...
import java.io.*;
// Description : You are given an equation of the form (a op1 b op2 c) mod p(a op1 b op2 c) mod p, where op1op1 and op2op2 are operators which can be +,−,∗,/+,−,∗,/. 
// It is guaranteed that (a,p)=(b,p)=(c,p)=1(a,p)=(b,p)=(c,p)=1 and pp is a prime number. 
